...
from keras.layers.experimental.preprocessing import TextVectorization, StringLookup
...
sub_model = build_model(80, 60,articleTypeLB=None, genderLB=None, baseColourLB=None, seasonLB=None, usageLB=None)
